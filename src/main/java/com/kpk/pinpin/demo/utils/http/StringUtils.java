...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    /**
     * 将字符进行分割，生成Integer类型列表list
     */
    public static List<Integer> splitToIntegerList(String str, String separatorChars) {
        List<Integer> list = Lists.newArrayList();
        /*if(StringUtils.isBlank(separatorChars)){
            separatorChars = ",";
    	}*/
        if (StringUtils.isNotBlank(str)) {
            String[] array = str.split(separatorChars);
    ...
    public static  <T>  String convertToSortedString(List<T> list) {
        if (!CollectionUtils.isEmpty(list)) {
            Collections.sort(list,(l1,l2)->l1.toString().compareToIgnoreCase(l2.toString()));
            StringBuilder sb = new StringBuilder();
            list.forEach(ll -> {
                sb.append(ll.toString()).append(",");
            });
